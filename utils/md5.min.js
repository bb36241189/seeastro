...
!function (t) {
  ...
  function a(n) {
    var t,
        r = [];
    for (r[(n.length >> 2) - 1] = undefined, t = 0; t < r.length; t += 1) r[t] = 0;
    var o = 8 * n.length;
  ...
  function m(n, t) {
    var r,
        ...
        u = [],
        f = [];
    for (u[15] = f[15] = undefined, e.length > 16 && (e = d(e, 8 * n.length)), r = 0; r < 16; r += 1) u[r] = 909522486 ^ e[r], f[r] = 1549556828 ^ e[r];
